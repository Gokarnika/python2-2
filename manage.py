...
def insert_default_products():
    ...
    if count == 0:
        default_products = [
            ...
            ('2024-07-18', 'Wheat Flour', 40, 'Grocery'),
            ('2024-07-18', 'Cooking Oil', 120, 'Grocery'),
            ('204-07-18', 'Sugar', 45, 'Grocery'),
            ('2024-07-18', 'Salt', 10, 'Grocery'),
            ('2024-07-18', 'Tea Powder', 150, 'Grocery'),
            ('2024-07-18', 'Coffee', 200, 'Grocery'),
            ('2024-07-18', 'Pulses', 70, 'Grocery'),
            # Food Items
            ('2024-07-18', 'Bread', 20, 'Food Items'),
            ('2024-07-18', 'Eggs', 5, 'Food Items'),
            ('2024-07-18', 'Milk', 30, 'Food Items'),
            ('2024-07-18', 'Butter', 60, 'Food Items'),
            ('2024-07-18', 'Cheese', 80, 'Food Items'),
            ('2024-07-18', 'Yogurt', 50, 'Food Items'),
            ('2024-07-18', 'Chicken', 180, 'Food Items'),
            ('2024-07-18', 'Fish', 220, 'Food Items'),
            # Clothes
            ('2024-07-18', 'T-Shirt', 250, 'Clothes'),
            ('2024-07-18', 'Jeans', 900, 'Clothes'),
            ('2024-07-18', 'Jacket', 1200, 'Clothes'),
            ('2024-07-18', 'Sweater', 600, 'Clothes'),
            ('2024-07-18', 'Cap', 150, 'Clothes'),
            ('2024-07-18', 'Socks', 100, 'Clothes'),
            ('2024-07-18', 'Scarf', 350, 'Clothes'),
            ('2024-07-18', 'Gloves', 200, 'Clothes'),
        ]
